...
- [프로젝트를 기획하게 된 계기](#프로젝트를-기획하게-된-계기)
...
```
이터러블 프로토콜에 따른 함수형 프로그래밍의 도입을 인하여 코드에 for 문이 없어지고, 코드가 선언적이게 되어서 한눈에 어떤 로직인 파악하기가 쉬워졌습니다.

<br>

>### 함수형 프로그래밍을 하면서 느낀점 부가 설명
>
>#### 함수형 프로그래밍의 장점
>- 지연성 평가와 커링을 이용하여서 함수의 평가 시점을 원하는 대로 컨트롤이 가능하고, 파이프 함수를 이용하여 함수 합성으로 새로운 함수를 만들 수가 있어서 함수의 재사용성이 더 좋아지는 장점이 있습니다.
...
## 프로젝트를 기획하게 된 계기
 프로젝트 아이디어를 짜던 중에 자바스크립트로 시스템(os)에 접근해 보고 싶다는 마음이 생기어 기획해 보게 되었습니다
