...
```
main Process에서 인터벌마다 실시간을 데이터를 수집하기 때문에 수집할 때 마다 구독자에게 알림을 주는 형식을 취하여서 관련된 데이터에 대한 인터벌을 한곳에서 관리하였습니다.  
...
프레임 워크 없이 혼자서 처음부터 무언가를 만들어보고, 평소에 잘 사용하지않았던 class도 써보고, 만들고 싶은 함수도 마음데로 만들어서 작업을 하였습니다. 이러한 과정에서 저의 코드가 발전하고 있음을 느꼈고, 앞으로도 잘 발전 해나갈수 있다는 자신감을 얻었습니다. 감사합니다.